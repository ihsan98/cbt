...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Jun 2021 pada 08.37
...
(4, 2, 'Bung Harto', 1),
(5, 6, 'FW Harris', 0),
(6, 6, 'Walter Stewart ', 0),
(7, 6, 'Simon Adam ', 0),
(8, 6, 'Adam Smith', 1),
(9, 5, 'implementasi', 0),
(10, 5, 'perencanaan penugasan', 0),
(11, 5, 'pengawasan tugas', 1),
(12, 5, 'evaluasi imbalan', 0),
(13, 4, 'minimum biaya', 1),
(14, 4, 'A dan C benar', 0),
(15, 4, 'maksimalisasi laba', 0),
(16, 4, 'efektivitas operasi', 0),
(17, 3, 'Perang Dunia II', 0),
(18, 3, 'pengawasan inventori', 1),
(19, 3, 'jumlah amunisi', 0),
(20, 3, 'pengawasan amunisi', 0);
...
(3, 1, 'Sejarah riset operasi tahun 1915 FW Harris membuat analisa kuantitatif untuk …'),
(4, 1, 'Fungsi riset operasi yang sebenarnya adalah untuk …'),
(5, 1, 'Alokasi karyawan dengan metode tertentu seperti Hungarian Method adalah termasuk kegiatan …'),
(6, 1, 'Pada tahun 1931 mulai dikenal statistik untuk pengawasan kualitas oleh …');
...
--
-- Stand-in struktur untuk tampilan `v_video`
